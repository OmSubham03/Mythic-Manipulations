...
const PATIENTS: PatientConfig[] = [
  ...
  },
  {
    ...
    glowColor: "#E8D088",
    accentColor: "#8B6914",
    image: require("../assets/images/sit_scarab.png"),
    stiffness: 0.9,
    patienceDuration: 30,
    rewardMultiplier: 1.5,
    baseReward: 100,
    description: "A golden beetle with cracked shell plates and gemstone eyes.",
    entrySound: "thud",
    level: 1,
    ailments: [
      {
        id: "scarab_eye",
        type: "EYE",
        label: "Sand-Blinded Gems",
        description: "Focus the blurry gem eyes!",
        gesture: "DRAG_DOWN",
        miniGame: "EYE_TEST",
        dragThreshold: 90,
        bodyZone: { x: 0.5, y: 0.16, size: 50 },
        crunchLabel: "GLEAM!",
      },
      {
        id: "scarab_chest",
        type: "CHEST",
        label: "Cracked Shell Core",
        description: "Pump the beetle heart!",
        gesture: "TAP_RAPID",
        miniGame: "HEART_PUMP",
        dragThreshold: 80,
        tapCount: 6,
        bodyZone: { x: 0.5, y: 0.42, size: 55 },
        crunchLabel: "CLICK!",
      },
    ],
  },
  {
    ...
    glowColor: "#F0F4FF",
    accentColor: "#8898B8",
    image: require("../assets/images/sit_sheep.png"),
    stiffness: 0.5,
    patienceDuration: 40,
    rewardMultiplier: 1.3,
    baseReward: 85,
    description: "A fluffy cloud sheep made of condensed mist.",
    entrySound: "poof",
    level: 1,
    ailments: [
      {
        id: "sheep_head",
        type: "HEAD",
        label: "Thunder Migraine",
        description: "Reconnect the head nerves!",
        gesture: "DRAG_DOWN",
        miniGame: "NERVE_LINK",
        dragThreshold: 95,
        bodyZone: { x: 0.5, y: 0.15, size: 52 },
        crunchLabel: "POOF!",
      },
      {
        id: "sheep_stomach",
        type: "STOMACH",
        label: "Rain Belly Bloat",
        description: "Find the path to release!",
        gesture: "DRAG_HORIZONTAL",
        miniGame: "FIND_PATH",
        dragThreshold: 90,
        bodyZone: { x: 0.5, y: 0.55, size: 55 },
        crunchLabel: "WHOOSH!",
      },
    ],
  },
  {
    type: "SHADOW_FOX",
    name: "Shade",
    kingdom: "Twilight Kingdom",
    bodyColor: "#2A2040",
    glowColor: "#6A58A0",
    accentColor: "#9B6EFF",
    image: require("../assets/images/sit_fox.png"),
    stiffness: 1.4,
    patienceDuration: 22,
    rewardMultiplier: 1.7,
    baseReward: 115,
    description: "A sleek dark fox with glowing purple markings.",
    entrySound: "zap",
    level: 1,
    ailments: [
      {
      ...
      },
      {
        id: "fox_leg",
        type: "LEG",
        label: "Phantom Limb Lock",
        description: "X-ray the leg bones!",
        gesture: "DRAG_DOWN",
        miniGame: "XRAY_SCAN",
        dragThreshold: 95,
        bodyZone: { x: 0.4, y: 0.75, size: 48 },
        crunchLabel: "CRACK!",
      },
    ],
  },
  {
    type: "CORAL_TURTLE",
    name: "Reef",
    kingdom: "Ocean Kingdom",
    bodyColor: "#48A8A0",
    glowColor: "#80D0C8",
    accentColor: "#FF7870",
    image: require("../assets/images/sit_turtle.png"),
    stiffness: 0.6,
    patienceDuration: 45,
    rewardMultiplier: 1.3,
    baseReward: 90,
    description: "A small turtle with a living coral shell.",
    entrySound: "rumble",
    level: 1,
    ailments: [
      {
        id: "turtle_back",
        type: "BACK",
        label: "Coral Shell Pressure",
        description: "Press the swelling down!",
        gesture: "DRAG_UP",
        miniGame: "SWELLING",
        dragThreshold: 110,
        bodyZone: { x: 0.5, y: 0.48, size: 60 },
        crunchLabel: "CRUNCH!",
      },
      {
        id: "turtle_teeth",
        type: "TEETH",
        label: "Barnacle Beak Jam",
        description: "Check the jammed beak!",
        gesture: "TAP_RAPID",
        miniGame: "DENTAL_CHECK",
        dragThreshold: 75,
        tapCount: 5,
        bodyZone: { x: 0.5, y: 0.20, size: 48 },
        crunchLabel: "SNAP!",
      },
    ],
  },
  {
    ...
    glowColor: "#D4843A",
    accentColor: "#FF6B00",
    image: require("../assets/images/sit_owl.png"),
    stiffness: 1.1,
    patienceDuration: 28,
    rewardMultiplier: 1.6,
    baseReward: 105,
    description: "A round owl with smoldering feathers and glowing ember eyes.",
    entrySound: "sizzle",
    level: 1,
    ailments: [
      {
