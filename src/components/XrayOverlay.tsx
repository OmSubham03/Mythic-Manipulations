  ...
  switch (type) {
    ...
    case "SNOW_LION":
      return "M 0.50 0.08 C 0.38 0.08, 0.30 0.14, 0.30 0.22 C 0.30 0.30, 0.38 0.34, 0.50 0.34 C 0.62 0.34, 0.70 0.30, 0.70 0.22 C 0.70 0.14, 0.62 0.08, 0.50 0.08 Z "
        + "M 0.44 0.34 L 0.44 0.38 L 0.56 0.38 L 0.56 0.34 "
        + "M 0.30 0.38 C 0.24 0.44, 0.22 0.56, 0.22 0.64 C 0.22 0.74, 0.34 0.78, 0.50 0.78 C 0.66 0.78, 0.78 0.74, 0.78 0.64 C 0.78 0.56, 0.76 0.44, 0.70 0.38 Z "
        + "M 0.34 0.78 L 0.32 0.92 M 0.44 0.78 L 0.44 0.92 "
        + "M 0.56 0.78 L 0.56 0.92 M 0.66 0.78 L 0.68 0.92 "
        + "M 0.78 0.62 C 0.84 0.66, 0.88 0.72, 0.86 0.80";
    case "GREEN_DEER":
      return "M 0.42 0.04 L 0.38 0.14 L 0.34 0.04 M 0.58 0.04 L 0.62 0.14 L 0.66 0.04 "
        + "M 0.50 0.10 C 0.42 0.10, 0.38 0.16, 0.38 0.22 C 0.38 0.28, 0.42 0.32, 0.50 0.32 C 0.58 0.32, 0.62 0.28, 0.62 0.22 C 0.62 0.16, 0.58 0.10, 0.50 0.10 Z "
        + "M 0.46 0.32 L 0.46 0.40 L 0.54 0.40 L 0.54 0.32 "
        ...
        + "M 0.56 0.74 L 0.56 0.92 M 0.64 0.74 L 0.66 0.92";
    case "SAND_SCARAB":
      return "M 0.50 0.12 C 0.40 0.12, 0.34 0.18, 0.34 0.24 C 0.34 0.30, 0.40 0.34, 0.50 0.34 C 0.60 0.34, 0.66 0.30, 0.66 0.24 C 0.66 0.18, 0.60 0.12, 0.50 0.12 Z "
        + "M 0.38 0.08 Q 0.34 0.04 0.30 0.02 M 0.62 0.08 Q 0.66 0.04 0.70 0.02 "
        + "M 0.30 0.36 C 0.22 0.42, 0.20 0.52, 0.20 0.60 C 0.20 0.72, 0.32 0.78, 0.50 0.78 C 0.68 0.78, 0.80 0.72, 0.80 0.60 C 0.80 0.52, 0.78 0.42, 0.70 0.36 Z "
        + "M 0.22 0.44 L 0.14 0.52 M 0.22 0.54 L 0.12 0.60 M 0.22 0.64 L 0.14 0.72 "
        + "M 0.78 0.44 L 0.86 0.52 M 0.78 0.54 L 0.88 0.60 M 0.78 0.64 L 0.86 0.72";
    case "CLOUD_SHEEP":
      return "M 0.50 0.10 C 0.40 0.10, 0.34 0.16, 0.34 0.24 C 0.34 0.32, 0.40 0.36, 0.50 0.36 C 0.60 0.36, 0.66 0.32, 0.66 0.24 C 0.66 0.16, 0.60 0.10, 0.50 0.10 Z "
        + "M 0.44 0.36 L 0.56 0.36 "
        + "M 0.26 0.40 C 0.20 0.46, 0.18 0.54, 0.18 0.64 C 0.18 0.74, 0.30 0.78, 0.50 0.78 C 0.70 0.78, 0.82 0.74, 0.82 0.64 C 0.82 0.54, 0.80 0.46, 0.74 0.40 Z "
        + "M 0.34 0.78 L 0.32 0.92 L 0.42 0.92 L 0.42 0.78 "
        + "M 0.58 0.78 L 0.58 0.92 L 0.68 0.92 L 0.68 0.78";
    case "SHADOW_FOX":
      return "M 0.42 0.06 L 0.36 0.18 M 0.58 0.06 L 0.64 0.18 "
        + "M 0.50 0.14 C 0.40 0.14, 0.34 0.20, 0.34 0.26 C 0.34 0.32, 0.40 0.36, 0.50 0.36 C 0.60 0.36, 0.66 0.32, 0.66 0.26 C 0.66 0.20, 0.60 0.14, 0.50 0.14 Z "
        + "M 0.44 0.36 L 0.44 0.40 L 0.56 0.40 L 0.56 0.36 "
        + "M 0.34 0.40 C 0.28 0.46, 0.26 0.56, 0.26 0.64 C 0.26 0.72, 0.36 0.76, 0.50 0.76 C 0.64 0.76, 0.74 0.72, 0.74 0.64 C 0.74 0.56, 0.72 0.46, 0.66 0.40 Z "
        + "M 0.34 0.76 L 0.32 0.92 M 0.44 0.76 L 0.44 0.92 "
        + "M 0.56 0.76 L 0.56 0.92 M 0.66 0.76 L 0.68 0.92 "
        + "M 0.74 0.62 C 0.80 0.58, 0.86 0.52, 0.90 0.46";
    case "CORAL_TURTLE":
      return "M 0.50 0.10 C 0.42 0.10, 0.38 0.16, 0.38 0.22 C 0.38 0.28, 0.42 0.32, 0.50 0.32 C 0.58 0.32, 0.62 0.28, 0.62 0.22 C 0.62 0.16, 0.58 0.10, 0.50 0.10 Z "
        + "M 0.46 0.32 L 0.46 0.36 L 0.54 0.36 L 0.54 0.32 "
        + "M 0.24 0.38 C 0.20 0.44, 0.18 0.52, 0.18 0.60 C 0.18 0.72, 0.30 0.78, 0.50 0.78 C 0.70 0.78, 0.82 0.72, 0.82 0.60 C 0.82 0.52, 0.80 0.44, 0.76 0.38 Z "
        + "M 0.24 0.48 L 0.14 0.54 L 0.14 0.66 L 0.24 0.62 "
        + "M 0.76 0.48 L 0.86 0.54 L 0.86 0.66 L 0.76 0.62 "
        + "M 0.38 0.78 L 0.36 0.90 M 0.62 0.78 L 0.64 0.90 "
        + "M 0.50 0.78 Q 0.52 0.84 0.50 0.88";
    case "EMBER_OWL":
      return "M 0.38 0.06 L 0.34 0.18 M 0.62 0.06 L 0.66 0.18 "
        + "M 0.50 0.12 C 0.38 0.12, 0.30 0.18, 0.30 0.26 C 0.30 0.34, 0.38 0.38, 0.50 0.38 C 0.62 0.38, 0.70 0.34, 0.70 0.26 C 0.70 0.18, 0.62 0.12, 0.50 0.12 Z "
        + "M 0.42 0.38 L 0.58 0.38 "
        + "M 0.28 0.40 C 0.22 0.46, 0.20 0.56, 0.20 0.64 C 0.20 0.74, 0.32 0.80, 0.50 0.80 C 0.68 0.80, 0.80 0.74, 0.80 0.64 C 0.80 0.56, 0.78 0.46, 0.72 0.40 Z "
        + "M 0.20 0.44 L 0.08 0.38 L 0.06 0.58 L 0.20 0.54 "
        + "M 0.80 0.44 L 0.92 0.38 L 0.94 0.58 L 0.80 0.54 "
        + "M 0.40 0.80 L 0.36 0.88 M 0.44 0.80 L 0.44 0.90 M 0.56 0.80 L 0.56 0.90 M 0.60 0.80 L 0.64 0.88";
    default:
      return "M 0.50 0.08 C 0.38 0.08, 0.30 0.14, 0.30 0.22 C 0.30 0.30, 0.38 0.34, 0.50 0.34 C 0.62 0.34, 0.70 0.30, 0.70 0.22 C 0.70 0.14, 0.62 0.08, 0.50 0.08 Z "
