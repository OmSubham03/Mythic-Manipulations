...
const SIT_IMAGES: Record<string, any> = {
  ...
  SAND_SCARAB: require("../assets/images/sit_scarab.png"),
  CLOUD_SHEEP: require("../assets/images/sit_sheep.png"),
  SHADOW_FOX: require("../assets/images/sit_fox.png"),
  CORAL_TURTLE: require("../assets/images/sit_turtle.png"),
  EMBER_OWL: require("../assets/images/sit_owl.png"),
};
...
const styles = StyleSheet.create({
  ...
  thoughtBubble: {
    ...
    paddingVertical: 10,
    borderRadius: 18,
    maxWidth: SPRITE_SIZE * 3.5,
    minWidth: SPRITE_SIZE * 1.8,
    elevation: 6,
    shadowColor: "#000",
    shadowOffset: { width: 0, height: 2 },
    shadowOpacity: 0.18,
